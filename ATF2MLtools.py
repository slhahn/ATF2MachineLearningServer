...
class ImageDeepLearning:
    #Deep Learning Image Model
    def model_predict(self, img_path, model_file,label_file,threshold, category):
...
class AudioProcessing:
    def detectAudioOnset():
        print("foo")
#AUDIO 
# Deep Learning audio prediction of Magic Leap audio classes from boot, islanda and oobe

class AudioDeepLearning:
